...
\begin{DoxyCompactItemize}
\item 
void \mbox{\hyperlink{assign_2main_8c_a633a5f11e0e40867cbb62222077211ce}{free\+List}} (struct building $\ast$$\ast$buildingL)
\item 
...
\item 
int \mbox{\hyperlink{assign_2main_8c_a3c04138a5bfe5d72780bb7e82a18e627}{main}} (int argc, char $\ast$$\ast$argv)
\end{DoxyCompactItemize}
...
\DoxyCodeLine{20     \{}
\DoxyCodeLine{21         \textcolor{keyword}{struct }building *buildingF = *(buildingL+i);}
\DoxyCodeLine{22         \textcolor{keyword}{struct }buildingType *values = buildingF-\/>values;}
...
\end{DoxyCode}
\mbox{\Hypertarget{assign_2main_8c_a3c04138a5bfe5d72780bb7e82a18e627}\label{assign_2main_8c_a3c04138a5bfe5d72780bb7e82a18e627}} 
...
\begin{DoxyCode}{0}
\DoxyCodeLine{148 \{}
\DoxyCodeLine{149     \textcolor{comment}{//init time}}
\DoxyCodeLine{150     \textcolor{keywordtype}{float} temps;}
\DoxyCodeLine{151     clock\_t t1, t2;}
\DoxyCodeLine{152     t1 = clock();}
\DoxyCodeLine{153     }
\DoxyCodeLine{154     \textcolor{comment}{// Ton programme}}
\DoxyCodeLine{155     \textcolor{keywordflow}{if}(argc != 3)}
\DoxyCodeLine{156     \{}
\DoxyCodeLine{157         printf(\textcolor{stringliteral}{"{}You have to pass two arguments: ./main [nbbat] [roof] \(\backslash\)n"{}});}
\DoxyCodeLine{158         \textcolor{keywordflow}{return} 0;}
\DoxyCodeLine{159     \}}
\DoxyCodeLine{160 }
\DoxyCodeLine{161     \textcolor{comment}{//init values}}
\DoxyCodeLine{162     \textcolor{keywordtype}{int} nbbat = (int) atol (argv[1]);}
\DoxyCodeLine{163     \textcolor{keywordtype}{int} roof = (int) atol (argv[2]);}
\DoxyCodeLine{164 }
\DoxyCodeLine{165     \textcolor{comment}{//test}}
\DoxyCodeLine{166     \mbox{\hyperlink{assign_2main_8c_a3d4cdb81f3bfaf77001e4b79839dfd75}{testAssign}}(nbbat, roof);}
\DoxyCodeLine{167 }
\DoxyCodeLine{168     \textcolor{comment}{//calcule de temps}}
\DoxyCodeLine{169     t2 = clock();}
\DoxyCodeLine{170     temps = (float)(t2-\/t1)/CLOCKS\_PER\_SEC;}
\DoxyCodeLine{171     printf(\textcolor{stringliteral}{"{}temps = \%f\(\backslash\)n"{}}, temps);}
...
References \mbox{\hyperlink{assign_2main_8c_a3d4cdb81f3bfaf77001e4b79839dfd75}{test\+Assign()}}.
...
\DoxyCodeLine{117 }
\DoxyCodeLine{118     printf(\textcolor{stringliteral}{"{}number of bavures = \%i\(\backslash\)n"{}}, numCom);}
\DoxyCodeLine{119 }
...
Referenced by \mbox{\hyperlink{assign_2main_8c_a3c04138a5bfe5d72780bb7e82a18e627}{main()}}, and \mbox{\hyperlink{input__gtk_8c_aa119a021d6e9b4f19136302b391de6fc}{on\+\_\+click\+\_\+button()}}.
