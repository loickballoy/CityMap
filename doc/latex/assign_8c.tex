...
In this file we place our buildings \begin{DoxyAuthor}{Author}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{380 \{}
\DoxyCodeLine{381   \textcolor{comment}{//finds the most optimal space for a new subway}}
\DoxyCodeLine{382 }
\DoxyCodeLine{383   *a = 0;}
\DoxyCodeLine{384   *b = 0;}
\DoxyCodeLine{385   \textcolor{keywordtype}{int} x = \mbox{\hyperlink{structmap}{map}}-\/>\mbox{\hyperlink{structmap_abcfc00fdba1d07bf4ea2626380b427d6}{maxWidth}} / 2;}
\DoxyCodeLine{386   \textcolor{keywordtype}{int} y = \mbox{\hyperlink{structmap}{map}}-\/>\mbox{\hyperlink{structmap_a946d2182ad7262a74e8674d94d6a1d3b}{maxHeight}} / 2; }
\DoxyCodeLine{387   }
\DoxyCodeLine{388   \textcolor{keywordtype}{int} startx = x-\/len/2 < 0 ? 0 : x-\/len/2;}
\DoxyCodeLine{389   \textcolor{keywordtype}{int} starty = y-\/len/2 < 0 ? 0 : y-\/len/2;}
\DoxyCodeLine{390   \textcolor{keyword}{struct }\mbox{\hyperlink{structcell}{cell}}* tempcell = \mbox{\hyperlink{structmap}{map}}-\/>\mbox{\hyperlink{structmap_ab5aacba1636793932a1893f75b3f561b}{cells}} + (startx + starty * \mbox{\hyperlink{structmap}{map}}-\/>\mbox{\hyperlink{structmap_abcfc00fdba1d07bf4ea2626380b427d6}{maxWidth}});}
\DoxyCodeLine{391   \textcolor{keywordtype}{int} endx = (x + len/2) >= \mbox{\hyperlink{structmap}{map}}-\/>\mbox{\hyperlink{structmap_abcfc00fdba1d07bf4ea2626380b427d6}{maxWidth}} ? \mbox{\hyperlink{structmap}{map}}-\/>\mbox{\hyperlink{structmap_abcfc00fdba1d07bf4ea2626380b427d6}{maxWidth}}-\/1 : x + len/2;}
\DoxyCodeLine{392   \textcolor{keywordtype}{int} endy = (y + len/2) >= \mbox{\hyperlink{structmap}{map}}-\/>\mbox{\hyperlink{structmap_a946d2182ad7262a74e8674d94d6a1d3b}{maxHeight}} ? \mbox{\hyperlink{structmap}{map}}-\/>\mbox{\hyperlink{structmap_a946d2182ad7262a74e8674d94d6a1d3b}{maxHeight}}-\/1 : (y + len/2);}
\DoxyCodeLine{393 }
\DoxyCodeLine{394 }
\DoxyCodeLine{395   \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} i = 0; i <= endx-\/startx; i++)}
\DoxyCodeLine{396   \{}
\DoxyCodeLine{397     }
\DoxyCodeLine{398     \textcolor{keywordflow}{if}((tempcell + i)-\/>stats[1] == 0)}
\DoxyCodeLine{399     \{}
\DoxyCodeLine{400       *a = startx+i;}
\DoxyCodeLine{401       *b = starty;}
\DoxyCodeLine{402       \textcolor{keywordflow}{return};}
\DoxyCodeLine{403     \}}
\DoxyCodeLine{404   \}}
\DoxyCodeLine{405   \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} j = 0; j <= endy-\/starty; j++)}
\DoxyCodeLine{406   \{}
\DoxyCodeLine{407     \textcolor{keywordflow}{if}((tempcell + j * \mbox{\hyperlink{structmap}{map}}-\/>\mbox{\hyperlink{structmap_abcfc00fdba1d07bf4ea2626380b427d6}{maxWidth}})-\/>stats[1] == 0)}
\DoxyCodeLine{408     \{}
\DoxyCodeLine{409       *a = startx;}
\DoxyCodeLine{410       *b = starty+j;}
\DoxyCodeLine{411       \textcolor{keywordflow}{return};}
\DoxyCodeLine{412     \}}
\DoxyCodeLine{413   \}}
\DoxyCodeLine{414 }
\DoxyCodeLine{415 }
\DoxyCodeLine{416   tempcell = \mbox{\hyperlink{structmap}{map}}-\/>\mbox{\hyperlink{structmap_ab5aacba1636793932a1893f75b3f561b}{cells}} + (startx + (endy * \mbox{\hyperlink{structmap}{map}}-\/>\mbox{\hyperlink{structmap_abcfc00fdba1d07bf4ea2626380b427d6}{maxWidth}}));}
\DoxyCodeLine{417   \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} i = 0; i <= endx-\/startx; i++)}
\DoxyCodeLine{418   \{}
\DoxyCodeLine{419     \textcolor{keywordflow}{if}((tempcell + i)-\/>stats[1] == 0)}
\DoxyCodeLine{420     \{}
\DoxyCodeLine{421       *a = startx+i;}
\DoxyCodeLine{422       *b = endy;}
\DoxyCodeLine{423       \textcolor{keywordflow}{return};}
\DoxyCodeLine{424     \}}
\DoxyCodeLine{425   \}}
\DoxyCodeLine{426 }
\DoxyCodeLine{427   tempcell = \mbox{\hyperlink{structmap}{map}}-\/>\mbox{\hyperlink{structmap_ab5aacba1636793932a1893f75b3f561b}{cells}} + (endx + (starty * \mbox{\hyperlink{structmap}{map}}-\/>\mbox{\hyperlink{structmap_abcfc00fdba1d07bf4ea2626380b427d6}{maxWidth}}));}
\DoxyCodeLine{428   \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} j = 0; j <= endy-\/starty; j++)}
\DoxyCodeLine{429   \{}
\DoxyCodeLine{430     \textcolor{keywordflow}{if}((tempcell + j * \mbox{\hyperlink{structmap}{map}}-\/>\mbox{\hyperlink{structmap_abcfc00fdba1d07bf4ea2626380b427d6}{maxWidth}})-\/>stats[1] == 0)}
\DoxyCodeLine{431     \{}
\DoxyCodeLine{432       *a = endx;}
\DoxyCodeLine{433       *b = starty+j;}
